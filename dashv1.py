# -*- coding: utf-8 -*-
"""
Grain Size Distribution – Master Dashboard with separate Mean ± SD plot
"""
            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        dcc.Graph(id="mean-sd-plot", style={"flex": "1", "minHeight": "0"})  # new panel
                    ]
                ),
...
def update_dashboard(boreholes, formations):
    ...
    # ← Set log x-axis like the main plot
